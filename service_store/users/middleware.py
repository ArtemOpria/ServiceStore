...
class RoleMiddleware:
    ...
    def __call__(self, request):
        ...
        if request.user.is_authenticated:
            ...
            # Check admin access - only users with admin role can access user management
            ...
            # Check manager access - only users with manager role can access service management
